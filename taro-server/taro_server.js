...
var WXBizDataCrypt = require('./lib/wxcrypt/WXBizDataCrypt');
...
app.post('/wxcrypt',function(req, res){
	res.status(200);
    res.set('Content-Type','application/json');
	
	var encryptedData=req.body.cryptData;
	var iv = req.body.iv;
	
	console.log('参数encryptedData: '+encryptedData)
	console.log('参数iv: '+iv)
	...
	data = {"errorCode":0,"errorMsg":null,"data":data};
